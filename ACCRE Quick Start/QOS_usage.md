...
```
ssh -t YOUR_VUNETID0@login.accre.vu "bash -l -c 'salloc --nodes=1 --ntasks=1 --cpus-per-task=10 --mem=64G --time=01-00:00:00 --partition=interactive --account=maiziezhou_lab_int --qos=maiziezhou_lab_int'"
```
